...
import { cloneArr, cloneObj, forEach, IDENTITY, isArray, isEmpty, isUndefined, keys, last, map, merge, NOOP, PRINT_WARNING, reduce, reject, toFastProperties } from "../utils/utils";
    ...
    function Lexer(lexerDefinition, config) {
        ...
        forEach(actualDefinition.modes, function (currModDef, currModName) {
            ...
            if (isEmpty(_this.lexerDefinitionErrors)) {
                ...
                var currAnalyzeResult = analyzeTokenTypes(currModDef, {
                ...
                _this.emptyGroups = merge(_this.emptyGroups, currAnalyzeResult.emptyGroups);
                _this.hasCustom =
        ...
        forEach(this.lexerDefinitionWarning, function (warningDescriptor) {
        ...
        var unOptimizedModes = reduce(this.canModeBeOptimized, function (cannotBeOptimized, canBeOptimized, modeName) {
