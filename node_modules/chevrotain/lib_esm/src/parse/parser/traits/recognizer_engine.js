...
import { AT_LEAST_ONE_IDX, AT_LEAST_ONE_SEP_IDX, BITS_FOR_METHOD_IDX, BITS_FOR_OCCURRENCE_IDX, MANY_IDX, MANY_SEP_IDX, OPTION_IDX, OR_IDX } from "../../grammar/keys";
...
var RecognizerEngine = /** @class */ (function () {
    ...
    RecognizerEngine.prototype.initRecognizerEngine = function (tokenVocabulary, config) {
        ...
        if (isArray(tokenVocabulary)) {
            this.tokensMap = reduce(tokenVocabulary, function (acc, tokenClazz) {
            ...
            this.tokensMap = reduce(uniqueTokens, function (acc, tokenClazz) {
                acc[tokenName(tokenClazz)] = tokenClazz;
                return acc;
            }, {});
        }
