...
export function validateGrammar(topLevels, maxLookahead, tokenTypes, ignoredIssues, errMsgProvider, grammarName) {
...
export function validateTokenName(tokenType, errMsgProvider) {
    var errors = [];
    var tokTypeName = tokenName(tokenType);
...
export function validateAmbiguousAlternationAlternatives(topLevelRule, maxLookahead, ignoredIssues, errMsgProvider) {
    var orCollector = new OrCollector();
    topLevelRule.accept(orCollector);
    var ors = orCollector.alternations;
    ...
    var errors = utils.reduce(ors, function (result, currOr) {
        ...
        var alternatives = getLookaheadPathsForOr(currOccurrence, topLevelRule, maxLookahead);
...
export function validateSomeNonEmptyLookaheadPath(topLevelRules, maxLookahead, errMsgProvider) {
    ...
    forEach(topLevelRules, function (currTopRule) {
        ...
        forEach(allRuleProductions, function (currProd) {
            ...
            var paths = getLookaheadPathsForOptionalProd(currOccurrence, currTopRule, prodType, maxLookahead);
...
function checkTerminalAndNoneTerminalsNameSpace(topLevels, tokenTypes, errMsgProvider) {
    var errors = [];
    var tokenNames = map(tokenTypes, function (currToken) { return tokenName(currToken); });
