...
export var BITS_FOR_METHOD_IDX = 4;
export var BITS_FOR_OCCURRENCE_IDX = 4;
export var BITS_FOR_RULE_IDX = 24;
...
/* tslint:disable */
export var OR_IDX = 1 << BITS_FOR_METHOD_IDX;
export var OPTION_IDX = 2 << BITS_FOR_METHOD_IDX;
export var MANY_IDX = 3 << BITS_FOR_METHOD_IDX;
export var AT_LEAST_ONE_IDX = 4 << BITS_FOR_METHOD_IDX;
export var MANY_SEP_IDX = 5 << BITS_FOR_METHOD_IDX;
export var AT_LEAST_ONE_SEP_IDX = 6 << BITS_FOR_METHOD_IDX;
/* tslint:enable */
