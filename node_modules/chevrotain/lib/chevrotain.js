...
Object.defineProperty(exports, "__esModule", { value: true });
var utils_1 = __webpack_require__(0);
var lang_extensions_1 = __webpack_require__(15);
var lexer_public_1 = __webpack_require__(7);
...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.performSelfAnalysis = function () {
        ...
        try {
            ...
            // Building the GAST
            utils_1.forEach(this.definedRulesNames, function (currRuleName) {
                var wrappedRule = _this[currRuleName];
                var originalGrammarAction = wrappedRule["originalGrammarAction"];
                var recordedRuleGast = _this.topLevelRuleRecord(currRuleName, originalGrammarAction);
        ...
        var resolverErrors = gast_resolver_public_1.resolveGrammar({
            rules: utils_1.values(this.gastProductionsCache)
        });
        ...
        if (utils_1.isEmpty(this.definitionErrors)) {
            ...
            var allFollows = follow_1.computeAllProdsFollows(utils_1.values(this.gastProductionsCache));
            this.resyncFollows = allFollows;
        }
        var cstAnalysisResult = cst_1.analyzeCst(utils_1.values(this.gastProductionsCache), this.fullRuleNameToShort);
...
var utils_1 = __webpack_require__(0);
var tokens_1 = __webpack_require__(5);
var lexer_errors_public_1 = __webpack_require__(22);
var reg_exp_parser_1 = __webpack_require__(17);
...
Object.defineProperty(exports, "__esModule", { value: true });
var regexp_to_ast_1 = __webpack_require__(16);
var regExpAstCache = {};
...
function firstCharOptimizedIndices(ast, result, ignoreCase) {
    switch (ast.type) {
        case "Disjunction":
            utils_1.forEach(ast.value, function (subAst) {
...
var GastRecorder = /** @class */ (function () {
    ...
    GastRecorder.prototype.enableRecording = function () {
        ...
        var _loop_1 = function (i) {
            var idx = i > 0 ? i : "";
            this_1["CONSUME" + idx] = function (arg1, arg2) {
                return this.consumeInternalRecord(arg1, i, arg2);
            };
            this_1["SUBRULE" + idx] = function (arg1, arg2) {
                return this.subruleInternalRecord(arg1, i, arg2);
            };
            this_1["OPTION" + idx] = function (arg1) {
                this.optionInternalRecord(arg1, i);
            };
            this_1["OR" + idx] = function (arg1) {
                return this.orInternalRecord(arg1, i);
            };
            this_1["MANY" + idx] = function (arg1) {
                this.manyInternalRecord(i, arg1);
            };
            this_1["MANY_SEP" + idx] = function (arg1) {
                this.manySepFirstInternalRecord(i, arg1);
            };
            this_1["AT_LEAST_ONE" + idx] = function (arg1) {
                this.atLeastOneInternalRecord(i, arg1);
            };
            this_1["AT_LEAST_ONE_SEP" + idx] = function (arg1) {
