    ...
    ***************************************************************************** */
    ...
    var SyncStorage = /** @class */ (function () {
        ...
        function (key) {
            ...
            return this.strategy.keyChanges.pipe(operators.filter((/**
             * @param {?} changed
             * @return {?}
             */
            function (changed) { return changed === null || changed === key; })), operators.switchMap((/**
             * @return {?}
             */
            function () { return _this.strategy.get(key); })), operators.distinctUntilChanged(), operators.shareReplay());
        };
        return SyncStorage;
    }());
    ...
    var AsyncStorage = /** @class */ (function () {
         ...
         */
        function (key) {
            return this.strategy.get(StorageKeyManager.normalize(key)).pipe(operators.map((/**
             * @param {?} value
             * @return {?}
             */
    ...
    var StrategyCacheService = /** @class */ (function () {
        ...
        /** @nocollapse */ StrategyCacheService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function StrategyCacheService_Factory() { return new StrategyCacheService(); }, token: StrategyCacheService, providedIn: "root" });
    ...
    var StorageStrategyStub = /** @class */ (function () {
        ...
        StorageStrategyStub.ctorParameters = function () { return [
            { type: String, decorators: [{ type: core.Optional }] }
        ]; };
    ...
    var StrategyIndex = /** @class */ (function () {
        ...
        /** @nocollapse */ StrategyIndex.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function StrategyIndex_Factory() { return new StrategyIndex(core.ɵɵinject(STORAGE_STRATEGIES, 8)); }, token: StrategyIndex, providedIn: "root" });
