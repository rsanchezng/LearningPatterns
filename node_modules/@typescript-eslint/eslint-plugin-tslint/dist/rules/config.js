 ...
 */
const tslintConfig = lodash_memoize_1.default((lintFile, tslintRules, tslintRulesDirectory) => {
    if (lintFile != null) {
...
exports.default = createRule({
    ...
    create(context) {
         ...
         */
        const { rules: tslintRules, rulesDirectory: tslintRulesDirectory, lintFile, } = context.options[0];
