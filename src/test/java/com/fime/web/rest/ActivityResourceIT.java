...
public class ActivityResourceIT {
    ...
    public void getAllActivities() throws Exception {
        ...
        restActivityMockMvc.perform(get("/api/activities?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].activityCreatedBy").value(hasItem(DEFAULT_ACTIVITY_CREATED_BY.toString())))
            .andExpect(jsonPath("$.[*].activityCreationDate").value(hasItem(DEFAULT_ACTIVITY_CREATION_DATE.toString())))
            .andExpect(jsonPath("$.[*].activityModifiedBy").value(hasItem(DEFAULT_ACTIVITY_MODIFIED_BY.toString())))
    ...
    public void getActivity() throws Exception {
        ...
        restActivityMockMvc.perform(get("/api/activities/{id}", activity.getId()))
            ...
            .andExpect(jsonPath("$.activityCreatedBy").value(DEFAULT_ACTIVITY_CREATED_BY.toString()))
            .andExpect(jsonPath("$.activityCreationDate").value(DEFAULT_ACTIVITY_CREATION_DATE.toString()))
            .andExpect(jsonPath("$.activityModifiedBy").value(DEFAULT_ACTIVITY_MODIFIED_BY.toString()))
