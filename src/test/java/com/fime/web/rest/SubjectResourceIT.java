...
public class SubjectResourceIT {
    ...
    public void getAllSubjects() throws Exception {
        ...
        restSubjectMockMvc.perform(get("/api/subjects?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].subjectDescription").value(hasItem(DEFAULT_SUBJECT_DESCRIPTION.toString())))
            .andExpect(jsonPath("$.[*].subjectCredits").value(hasItem(DEFAULT_SUBJECT_CREDITS)))
            .andExpect(jsonPath("$.[*].subjectCreatedBy").value(hasItem(DEFAULT_SUBJECT_CREATED_BY.toString())))
            .andExpect(jsonPath("$.[*].subjectCreationDate").value(hasItem(DEFAULT_SUBJECT_CREATION_DATE.toString())))
            .andExpect(jsonPath("$.[*].subjectModifiedBy").value(hasItem(DEFAULT_SUBJECT_MODIFIED_BY.toString())))
    ...
    public void getSubject() throws Exception {
        ...
        restSubjectMockMvc.perform(get("/api/subjects/{id}", subject.getId()))
            ...
            .andExpect(jsonPath("$.subjectDescription").value(DEFAULT_SUBJECT_DESCRIPTION.toString()))
            .andExpect(jsonPath("$.subjectCredits").value(DEFAULT_SUBJECT_CREDITS))
            .andExpect(jsonPath("$.subjectCreatedBy").value(DEFAULT_SUBJECT_CREATED_BY.toString()))
            .andExpect(jsonPath("$.subjectCreationDate").value(DEFAULT_SUBJECT_CREATION_DATE.toString()))
            .andExpect(jsonPath("$.subjectModifiedBy").value(DEFAULT_SUBJECT_MODIFIED_BY.toString()))
