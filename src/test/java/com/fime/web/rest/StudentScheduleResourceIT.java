...
public class StudentScheduleResourceIT {
    ...
    private static final String DEFAULT_SCHEDULE_CREATED_BY = "AAAAAAAAAA";
    private static final String UPDATED_SCHEDULE_CREATED_BY = "BBBBBBBBBB";

    private static final LocalDate DEFAULT_SCHEDULE_CREATION_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_SCHEDULE_CREATION_DATE = LocalDate.now(ZoneId.systemDefault());

    private static final String DEFAULT_SCHEDULE_MODIFIED_BY = "AAAAAAAAAA";
    private static final String UPDATED_SCHEDULE_MODIFIED_BY = "BBBBBBBBBB";

    private static final LocalDate DEFAULT_SCHEDULE_MODIFIED_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_SCHEDULE_MODIFIED_DATE = LocalDate.now(ZoneId.systemDefault());
    ...
    public static StudentSchedule createEntity(EntityManager em) {
        StudentSchedule studentSchedule = new StudentSchedule()
            .scheduleCreatedBy(DEFAULT_SCHEDULE_CREATED_BY)
            .scheduleCreationDate(DEFAULT_SCHEDULE_CREATION_DATE)
            .scheduleModifiedBy(DEFAULT_SCHEDULE_MODIFIED_BY)
            .scheduleModifiedDate(DEFAULT_SCHEDULE_MODIFIED_DATE);
    ...
    public static StudentSchedule createUpdatedEntity(EntityManager em) {
        StudentSchedule studentSchedule = new StudentSchedule()
            .scheduleCreatedBy(UPDATED_SCHEDULE_CREATED_BY)
            .scheduleCreationDate(UPDATED_SCHEDULE_CREATION_DATE)
            .scheduleModifiedBy(UPDATED_SCHEDULE_MODIFIED_BY)
            .scheduleModifiedDate(UPDATED_SCHEDULE_MODIFIED_DATE);
        return studentSchedule;
    }
    ...
    public void createStudentSchedule() throws Exception {
        ...
        assertThat(testStudentSchedule.getScheduleCreatedBy()).isEqualTo(DEFAULT_SCHEDULE_CREATED_BY);
        assertThat(testStudentSchedule.getScheduleCreationDate()).isEqualTo(DEFAULT_SCHEDULE_CREATION_DATE);
        assertThat(testStudentSchedule.getScheduleModifiedBy()).isEqualTo(DEFAULT_SCHEDULE_MODIFIED_BY);
        assertThat(testStudentSchedule.getScheduleModifiedDate()).isEqualTo(DEFAULT_SCHEDULE_MODIFIED_DATE);
    }
    ...
    public void getAllStudentSchedules() throws Exception {
        ...
        restStudentScheduleMockMvc.perform(get("/api/student-schedules?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].scheduleCreatedBy").value(hasItem(DEFAULT_SCHEDULE_CREATED_BY)))
            .andExpect(jsonPath("$.[*].scheduleCreationDate").value(hasItem(DEFAULT_SCHEDULE_CREATION_DATE.toString())))
            .andExpect(jsonPath("$.[*].scheduleModifiedBy").value(hasItem(DEFAULT_SCHEDULE_MODIFIED_BY)))
            .andExpect(jsonPath("$.[*].scheduleModifiedDate").value(hasItem(DEFAULT_SCHEDULE_MODIFIED_DATE.toString())));
    }
    ...
    public void getStudentSchedule() throws Exception {
        ...
        restStudentScheduleMockMvc.perform(get("/api/student-schedules/{id}", studentSchedule.getId()))
            ...
            .andExpect(jsonPath("$.scheduleCreatedBy").value(DEFAULT_SCHEDULE_CREATED_BY))
            .andExpect(jsonPath("$.scheduleCreationDate").value(DEFAULT_SCHEDULE_CREATION_DATE.toString()))
            .andExpect(jsonPath("$.scheduleModifiedBy").value(DEFAULT_SCHEDULE_MODIFIED_BY))
            .andExpect(jsonPath("$.scheduleModifiedDate").value(DEFAULT_SCHEDULE_MODIFIED_DATE.toString()));
    }
    ...
    public void updateStudentSchedule() throws Exception {
        ...
        StudentSchedule testStudentSchedule = studentScheduleList.get(studentScheduleList.size() - 1);
        assertThat(testStudentSchedule.getScheduleCreatedBy()).isEqualTo(UPDATED_SCHEDULE_CREATED_BY);
        assertThat(testStudentSchedule.getScheduleCreationDate()).isEqualTo(UPDATED_SCHEDULE_CREATION_DATE);
        assertThat(testStudentSchedule.getScheduleModifiedBy()).isEqualTo(UPDATED_SCHEDULE_MODIFIED_BY);
        assertThat(testStudentSchedule.getScheduleModifiedDate()).isEqualTo(UPDATED_SCHEDULE_MODIFIED_DATE);
    }
