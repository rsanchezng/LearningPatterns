...
public class PDDLTest {
	...
	public static void main(String[] args) throws IOException {
        ...
        Activity activity1 = new Activity("Activity1", "Activity1", subtheme1, null, false, 15, 50, 50, resources);
        activites.add(activity1);
        
        List<String> dependencies = new ArrayList<>();
        dependencies.add("Theme1");
        
        Activity activity2 = new Activity("Activity2", "Activity2", subtheme1, dependencies, false, 15, 50, 50, resources);
